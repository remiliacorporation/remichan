...
func createBoard(w http.ResponseWriter, r *http.Request) {
	err := func() (err error) {
		...
		// only admins should be able to create boards.
		err = isAdmin(w, r)
		if err != nil {
			return
		}
...
func moderatePosts(w http.ResponseWriter, r *http.Request,
	...
	err := func() (err error) {
		...
		var msg = strings.Trim(strings.Join(strings.Fields(fmt.Sprint(ids)), ", "), "[]")

		os.Stdout.WriteString("\ndeleting")
		os.Stdout.WriteString(msg)
		os.Stdout.WriteString(" initiated by " + creds.UserID + "\n")
