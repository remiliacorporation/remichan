...
const (
	...
	DefaultConnArgs = "host=localhost user=meguca password=meguca dbname=meguca sslmode=disable binary_parameters=yes port=5432"
)
...
func loadDB(dbSuffix string) (err error) {
	...
	if !common.IsTest {
		os.Stdout.WriteString("\n RUNNING CLEANUP TASKS GOROUTINE \n")
		go runCleanupTasks()
	}
